...
exercide_plan = pd.read_csv("datasets\workout_df.csv")
disease_description = pd.read_csv("datasets\description.csv")
medications_info = pd.read_csv("datasets\medications.csv")
diets_info = pd.read_csv("datasets\diets.csv")
...
# create a route foe the home page 
@app.route('/')
def index():
